...
Local MCP server running at `http://127.0.0.1:8123`.
...
- **Args:** none.
- **Example LLM prompt:** “Give me a quick health check of this machine.”
...
- **Args:** none.
- **Example prompt:** “Is my VPN connected and what’s the adapter status?”
...
- Combine with chat prompts like “Use tools if needed: …” so the LLM calls the right tool.*** End Patch
